# TODO: test User.authenticate method and other tests.
...
class UserModelTestCase(TestCase):
    ...
    def test_user_signup_successful(self):
        ...
        # TODO: refactor considering two possibilities: 
        #   can test test_user.password !-= plaintext
        #   check first char of hased password
